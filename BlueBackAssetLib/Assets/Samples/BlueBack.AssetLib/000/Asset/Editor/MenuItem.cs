...
/** BlueBack.AssetLib.Samples.Asset.Editor
*/
namespace BlueBack.AssetLib.Samples.Asset.Editor
{
	/** MenuItem
	*/
	#if(UNITY_EDITOR)
	public class MenuItem
	{
		...
		*/
		[UnityEditor.MenuItem("Samples/BlueBack.AssetLib/Asset/LoadAssetWithAssetsPath")]

	...
	*/
	...
	public class MenuItem
	{
		...
		*/
		...
		{
			UnityEngine.TextAsset t_textasset = BlueBack.AssetLib.Editor.LoadAssetWithPackagesPath.Load<UnityEngine.TextAsset>("blueback.jsonitem/README.md");
		...
		*/
		...
		private static void MenuItem_LoadAllAssetsFromAssetsPath()
		{
			...
			//全部。
			{
				UnityEngine.Object[] t_list = BlueBack.AssetLib.Editor.LoadAssetWithAssetsPath.LoadAll("Samples/AssetLib/ab.prefab");
			...
			//指定型。
			{
				System.Collections.Generic.List<UnityEngine.MonoBehaviour> t_list = BlueBack.AssetLib.Editor.LoadAssetWithAssetsPath.LoadAll<UnityEngine.MonoBehaviour>("Samples/AssetLib/ab.prefab");

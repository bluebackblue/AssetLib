...
namespace BlueBack.AssetLib.Editor
{
	...
	*/
	public static class SaveText
	{
		...
		*/
		public static bool SaveUtf8TextToAssetsPath(string a_text,string a_assets_path_with_extention,bool a_bom,LineFeedOption a_linefeed_option)
		{
			string t_text;
		...
		*/
		public static bool TrySaveUtf8TextToAssetsPath(string a_text,string a_assets_path_with_extention,bool a_bom,LineFeedOption a_linefeed_option)
		{
			...
			try{
				t_result = SaveUtf8TextToAssetsPath(a_text,a_assets_path_with_extention,a_bom,a_linefeed_option);

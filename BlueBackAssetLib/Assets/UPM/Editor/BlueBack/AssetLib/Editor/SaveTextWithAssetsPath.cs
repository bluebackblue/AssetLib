	...
	*/
	public static class SaveTextWithAssetsPath
	{
		...
		*/
		...
		{
			return SaveTextWithFullPath.Save(a_text,AssetLib.application_data_path + '\\' + a_assets_path_with_extention,a_encoding,a_linefeedoption);
		}
		...
		*/
		...
		{
			return SaveTextWithFullPath.SaveNoBomUtf8(a_text,AssetLib.application_data_path + '\\' + a_assets_path_with_extention,a_linefeedoption);
		}

	...
	*/
	public static class LoadBinaryWithAssetsPath
	{
		...
		*/
		...
		{
			return LoadBinaryWithFullPath.Load(AssetLib.GetApplicationDataPath() + '\\' + a_assets_path_with_extention);
		}
		...
		*/
		...
		{
			return LoadBinaryWithFullPath.LoadToBuffer(AssetLib.GetApplicationDataPath() + '\\' + a_assets_path_with_extention,a_buffer);
		}

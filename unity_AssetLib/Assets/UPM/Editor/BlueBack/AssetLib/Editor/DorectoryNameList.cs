...
namespace BlueBack.AssetLib.Editor
{
	...
	*/
	public class DirectoryNameList
	{
		...
		*/
		public static System.Collections.Generic.List<string> CreateOnlyTopDirectoryNameListFromFullPath(string a_full_path)
		{
			System.Collections.Generic.List<string> t_list = new System.Collections.Generic.List<string>();
			{
				string[] t_fullpath_list = System.IO.Directory.GetDirectories(a_full_path,"*",System.IO.SearchOption.TopDirectoryOnly);
		...
		*/
		public static System.Collections.Generic.List<string> CreateAllDirectoryNameListFromFullPath(string a_full_path)
		{
			...
			while(t_work.Count > 0){
				...
				System.Collections.Generic.List<string> t_directory_name_list = CreateOnlyTopDirectoryNameListFromFullPath(t_path);
		...
		*/
		public static Result<System.Collections.Generic.List<string>> TryCreateOnlyTopDirectoryNameListFromFullPath(string a_full_path)
		{
			Result<System.Collections.Generic.List<string>> t_result;

			#pragma warning disable 0168
			try{
				t_result.value = CreateOnlyTopDirectoryNameListFromFullPath(a_full_path);
		...
		*/
		public static Result<System.Collections.Generic.List<string>> TryCreateAllDirectoryNameListFromFullPath(string a_full_path)
		{
			Result<System.Collections.Generic.List<string>> t_result;

			#pragma warning disable 0168
			try{
				t_result.value = CreateAllDirectoryNameListFromFullPath(a_full_path);
				t_result.success = true;
			}catch(System.IO.IOException t_exception){
				#if(DEF_BLUEBACK_ASSETLIB_ASSERT)
				DebugTool.Assert(false,t_exception);
